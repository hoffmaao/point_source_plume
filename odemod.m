...
% ********
%----------------------------------------------------------------------%
% This modified version of ODE45 is designed for use with an ISW plume
% model.  The modifications allow for the integration to finish when
% the plume buoyancy reaches zero, irrespective of whether "tfinal" has
% been reached or not.
%
% Modifications done by Adrian Jenkins, 22-8-97.
%----------------------------------------------------------------------%

function [tout, yout] = odemod(ypfun, t0, tfinal, y0, tol, trace)
